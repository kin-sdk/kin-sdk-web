...
export class TransactionError extends jspb.Message {
  getReason(): TransactionError.ReasonMap[keyof TransactionError.ReasonMap];
  setReason(value: TransactionError.ReasonMap[keyof TransactionError.ReasonMap]): void;

  getInstructionIndex(): number;
  setInstructionIndex(value: number): void;
...
export namespace TransactionError {
  export type AsObject = {
    reason: TransactionError.ReasonMap[keyof TransactionError.ReasonMap],
...
export const Commitment: CommitmentMap;
