...
export class Invoice extends jspb.Message {
  ...
  setItemsList(value: Array<Invoice.LineItem>): void
...
export namespace Invoice {
  ...
  export class LineItem extends jspb.Message {
    ...
    getSku_asB64(): string
    setSku(value: Uint8Array | string): void
...
export class InvoiceError extends jspb.Message {
  ...
  getReason(): InvoiceError.ReasonMap[keyof InvoiceError.ReasonMap]
  setReason(value: InvoiceError.ReasonMap[keyof InvoiceError.ReasonMap]): void
...
export namespace InvoiceError {
  export type AsObject = {
    ...
    reason: InvoiceError.ReasonMap[keyof InvoiceError.ReasonMap]
  }
