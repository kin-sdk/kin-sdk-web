...
export class AccountClient {
  ...
  createAccount(
    ...
    callback: (
      ...
      responseMessage: account_v4_account_service_pb.CreateAccountResponse | null,
    ) => void,
  ): UnaryResponse
  createAccount(
    requestMessage: account_v4_account_service_pb.CreateAccountRequest,
  ...
  getAccountInfo(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: account_v4_account_service_pb.GetAccountInfoResponse | null,
    ) => void,
  ): UnaryResponse
  getAccountInfo(
    requestMessage: account_v4_account_service_pb.GetAccountInfoRequest,
  ...
  resolveTokenAccounts(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: account_v4_account_service_pb.ResolveTokenAccountsResponse | null,
    ) => void,
  ): UnaryResponse
  resolveTokenAccounts(
    requestMessage: account_v4_account_service_pb.ResolveTokenAccountsRequest,
  ...
  getEvents(
    requestMessage: account_v4_account_service_pb.GetEventsRequest,
    metadata?: grpc.Metadata,
  ): ResponseStream<account_v4_account_service_pb.Events>
}
