...
export class TransactionClient {
  ...
  getHistory(
    ...
    callback: (
      ...
      responseMessage: transaction_v3_transaction_service_pb.GetHistoryResponse | null,
    ) => void,
  ): UnaryResponse
  getHistory(
    requestMessage: transaction_v3_transaction_service_pb.GetHistoryRequest,
  ...
  submitTransaction(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: transaction_v3_transaction_service_pb.SubmitTransactionResponse | null,
    ) => void,
  ): UnaryResponse
  submitTransaction(
    requestMessage: transaction_v3_transaction_service_pb.SubmitTransactionRequest,
  ...
  getTransaction(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: transaction_v3_transaction_service_pb.GetTransactionResponse | null,
    ) => void,
  ): UnaryResponse
  getTransaction(
    requestMessage: transaction_v3_transaction_service_pb.GetTransactionRequest,
