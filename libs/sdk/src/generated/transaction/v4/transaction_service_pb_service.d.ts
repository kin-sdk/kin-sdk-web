...
export class TransactionClient {
  ...
  getServiceConfig(
    ...
    callback: (
      ...
      responseMessage: transaction_v4_transaction_service_pb.GetServiceConfigResponse | null,
    ) => void,
  ): UnaryResponse
  getServiceConfig(
    requestMessage: transaction_v4_transaction_service_pb.GetServiceConfigRequest,
  ...
  getMinimumKinVersion(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: transaction_v4_transaction_service_pb.GetMinimumKinVersionResponse | null,
    ) => void,
  ): UnaryResponse
  getMinimumKinVersion(
    requestMessage: transaction_v4_transaction_service_pb.GetMinimumKinVersionRequest,
  ...
  getRecentBlockhash(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: transaction_v4_transaction_service_pb.GetRecentBlockhashResponse | null,
    ) => void,
  ): UnaryResponse
  getRecentBlockhash(
    requestMessage: transaction_v4_transaction_service_pb.GetRecentBlockhashRequest,
  ...
  getMinimumBalanceForRentExemption(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: transaction_v4_transaction_service_pb.GetMinimumBalanceForRentExemptionResponse | null,
    ) => void,
  ): UnaryResponse
  getMinimumBalanceForRentExemption(
    requestMessage: transaction_v4_transaction_service_pb.GetMinimumBalanceForRentExemptionRequest,
  ...
  getHistory(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: transaction_v4_transaction_service_pb.GetHistoryResponse | null,
    ) => void,
  ): UnaryResponse
  getHistory(
    requestMessage: transaction_v4_transaction_service_pb.GetHistoryRequest,
  ...
  submitTransaction(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: transaction_v4_transaction_service_pb.SubmitTransactionResponse | null,
    ) => void,
  ): UnaryResponse
  submitTransaction(
    requestMessage: transaction_v4_transaction_service_pb.SubmitTransactionRequest,
  ...
  getTransaction(
    ...
    callback: (
      error: ServiceError | null,
      responseMessage: transaction_v4_transaction_service_pb.GetTransactionResponse | null,
    ) => void,
  ): UnaryResponse
  getTransaction(
    requestMessage: transaction_v4_transaction_service_pb.GetTransactionRequest,
