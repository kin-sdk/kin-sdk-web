    ...
    <div>
      ...
      >
        <div className="flex justify-between items-center">
          ...
          <div className="flex justify-between items-center space-x-2">
            <span>$27.05</span> 
              <button onClick={toggleDetails}><BiChevronUp className="text-3xl" />
              </button>
          </div>
        </div>
      </div>
      {showDetails ? (
        <div className="px-6 py-4">
          <div className="flex justify-evenly">
            ...
            <button  
            className="px-4 py-2 rounded-3xl border border-indigo-400 text-indigo-400 hover:bg-primary-400 hover:font-bold hover:text-white">Send</button>
          </div>
          <div className="pt-2 flex flex-col ml-10">
            <a href="#" className="text-sm hover:underline text-blue-400">Token Name: {tokenName}</a>

            <hr className="border-1 stroke-1 border-opacity-25"/>

            <a href="#" className="text-sm hover:underline text-blue-400">Token Symbol: {tokenSymbol}</a>
